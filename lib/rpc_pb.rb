...
Google::Protobuf::DescriptorPool.generated_pool.build do
  add_message "lnrpc.CreateWalletRequest" do
    optional :password, :bytes, 1
  end
  add_message "lnrpc.CreateWalletResponse" do
  end
  ...
  add_message "lnrpc.PendingChannelResponse" do
    ...
    repeated :pending_open_channels, :message, 2, "lnrpc.PendingChannelResponse.PendingOpenChannel"
    repeated :pending_closing_channels, :message, 3, "lnrpc.PendingChannelResponse.ClosedChannel"
    repeated :pending_force_closing_channels, :message, 4, "lnrpc.PendingChannelResponse.ForceClosedChannel"
  end
  ...
  add_message "lnrpc.PendingChannelResponse.PendingOpenChannel" do
    optional :channel, :message, 1, "lnrpc.PendingChannelResponse.PendingChannel"
    optional :confirmation_height, :uint32, 2
    optional :blocks_till_open, :int32, 3
    optional :commit_fee, :int64, 4
    optional :commit_weight, :int64, 5
    optional :fee_per_kw, :int64, 6
  end
  add_message "lnrpc.PendingChannelResponse.ClosedChannel" do
    optional :channel, :message, 1, "lnrpc.PendingChannelResponse.PendingChannel"
    optional :closing_txid, :string, 2
  end
  add_message "lnrpc.PendingChannelResponse.ForceClosedChannel" do
    optional :channel, :message, 1, "lnrpc.PendingChannelResponse.PendingChannel"
    optional :closing_txid, :string, 2
  ...
  add_message "lnrpc.FeeUpdateRequest" do
  ...
  add_message "lnrpc.FeeUpdateResponse" do
  end
end

module Lnrpc
  CreateWalletRequest = Google::Protobuf::DescriptorPool.generated_pool.lookup("lnrpc.CreateWalletRequest").msgclass
  CreateWalletResponse = Google::Protobuf::DescriptorPool.generated_pool.lookup("lnrpc.CreateWalletResponse").msgclass
  ...
  PendingChannelResponse::PendingOpenChannel = Google::Protobuf::DescriptorPool.generated_pool.lookup("lnrpc.PendingChannelResponse.PendingOpenChannel").msgclass
  PendingChannelResponse::ClosedChannel = Google::Protobuf::DescriptorPool.generated_pool.lookup("lnrpc.PendingChannelResponse.ClosedChannel").msgclass
  PendingChannelResponse::ForceClosedChannel = Google::Protobuf::DescriptorPool.generated_pool.lookup("lnrpc.PendingChannelResponse.ForceClosedChannel").msgclass
  ...
  FeeUpdateRequest = Google::Protobuf::DescriptorPool.generated_pool.lookup("lnrpc.FeeUpdateRequest").msgclass
  FeeUpdateResponse = Google::Protobuf::DescriptorPool.generated_pool.lookup("lnrpc.FeeUpdateResponse").msgclass
end
